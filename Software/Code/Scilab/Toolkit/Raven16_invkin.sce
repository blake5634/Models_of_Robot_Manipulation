// EE543  Project 50 Raven II Inverse Kinematics
//
//     V 1.0     June 2016
//     Only 2 solutions!
//
...
function T06 = Raven16_for_kin(q)
...
function DH = Raven16_dh(q)  // q is vector of joint positions
    DH = [ 0            0   0       q(1) ;
           la12         0   0       q(2);
           180-la23     0   q(3)    90;
           0            a3  d4      q(4);
...
//
function q_return = Raven16_inv_kin(T06)
    //  T = T06 desired
