...
//    mprintf("th2 = [%f %f %f %f ]\n", q2a1,q2a2,q2b1,q2b2);
    ...
    /////////////////////////////////   Th 1
    // Theta 1 (also 4 solns)
    
    // th2a1  d3.1
    b1L = sind(q2a1)*g3 ;
    b2L = cosd(q2a1)*g2*g3-g1*g4 ;
    B = [ b1L  b2L ; -b2L b1L];
    cs1 = 1/d1* inv(B)*[Xp, Yp]'; // eqn (50)
    q1a1 = 360/(2*%pi)*atan(cs1(2),cs1(1));
    
    //  th2a2  d3.1
    b1L = sind(q2a2)*g3 ;
    b2L = cosd(q2a2)*g2*g3-g1*g4 ;
    B = [ b1L  b2L ; -b2L b1L];
    cs1 = 1/d1* inv(B)*[Xp, Yp]'; // eqn (50)
    q1a2 = 360/(2*%pi)*atan(cs1(2),cs1(1));    
//    
    // th2b1   d3.2
    b1L = sind(q2b1)*g3 ;
    b2L = cosd(q2b1)*g2*g3-g1*g4 ;
    B = [ b1L  b2L ; -b2L b1L];
    cs1 = 1/d1* inv(B)*[Xp, Yp]'; // eqn (50)
    q1b1 = 360/(2*%pi)*atan(cs1(2),cs1(1));
//            
    // th2b2   d3.2
    b1L = sind(q2b2)*g3 ;
    b2L = cosd(q2b2)*g2*g3-g1*g4 ;
    B = [ b1L  b2L ; -b2L b1L];
    cs1 = 1/d1* inv(B)*[Xp, Yp]'; // eqn (50) 
    q1b2 = 360/(2*%pi)*atan(cs1(2),cs1(1));
...
//       mprintf("c5: %f\n",c5);
    ...
    r = eval_theta456([q1a1  q2a1  q3a], T06);
 
    q4a1 = r(1);
    q5a1 = r(2);
    q6a1 = r(3);
    
    r = eval_theta456([q1a2  q2a2  q3a], T06);
 
    q4a2 = r(1);
    q5a2 = r(2);
    q6a2 = r(3);
//    
    r = eval_theta456([q1b1  q2b1  q3b], T06);
 
    q4b1 = r(1);
    q5b1 = r(2);
    q6b1 = r(3);
//    
    r = eval_theta456([q1b2  q2b2  q3b], T06);
...
//              q6a1,q6a2,q6b1,q6b2) ;
    ...
    q_return = [q1a1 q2a1 q3a q4a1 q5a1 q6a1;  ...
                q1a2 q2a2 q3a q4a2 q5a2 q6a2;  ... 
                q1b1 q2b1 q3b q4b1 q5b1 q6b1;  ...//  these work!(?)
                q1b2 q2b2 q3b q4b2 q5b2 q6b2 ];   // 
