...
\title{ICP: Link frame assignments}
...
Assign link frames to the following robot.  Note that it has a prismatic joint.

\vspace{0.5in}
\includegraphics[width=4.0in]{00836.png}


\newpage
\section{}

Assign link frames to the following robot.  Note that it has some joint axes which intersect.
\vspace{0.5in}

\includegraphics[width=4.0in]{00837.png}
