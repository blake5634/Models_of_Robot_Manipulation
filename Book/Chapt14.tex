...
\includegraphics[width=3.0in]{figs14/00406.eps}
 ...
 Operator first works with index offset $j$, and then creates a new offset $^m_FT_{j+1}$ by pressing a button and moving the leader to a new location (with the follower frozen).  Analyzing the diagram, 	%<hn>
